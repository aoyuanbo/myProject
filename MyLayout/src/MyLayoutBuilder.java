...
public class MyLayoutBuilder implements LayoutBuilder{
    ...
    public String getName() {
        return NbBundle.getMessage(MyLayoutBuilder.class, "name"); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public MyLayout buildLayout() {
        return new MyLayout(this); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private class MyLayoutBuilderUI implements LayoutUI{
        ...
        public String getDescription() {
            return NbBundle.getMessage(MyLayout.class, "description"); //To change body of generated methods, choose Tools | Templates.
        }
